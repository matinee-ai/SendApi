...
class ResponsePanel(QWidget):
    ...
    def init_ui(self):
        ...
        response_label.setStyleSheet("font-weight: bold; font-size: 14px; color: #2c3e50; padding: 5px; background-color: #ecf0f1; border-radius: 3px;")
    ...
    def create_cookies_tab(self):
        ...
        self.cookies_table.setHorizontalHeaderLabels(["Name", "Value", "Domain", "Path"])
    ...
    def display_response(self, response_data):
        ...
        print(f"ResponsePanel: Received response with status {response_data.get('status_code', 'Unknown')}")
        ...
        if 200 <= status_code < 300:
            self.status_code_label.setStyleSheet("color: green; font-weight: bold; font-size: 14px;")
        elif 300 <= status_code < 400:
            self.status_code_label.setStyleSheet("color: orange; font-weight: bold; font-size: 14px;")
        elif 400 <= status_code < 500:
            self.status_code_label.setStyleSheet("color: red; font-weight: bold; font-size: 14px;")
        elif 500 <= status_code < 600:
            self.status_code_label.setStyleSheet("color: darkred; font-weight: bold; font-size: 14px;")
        else:
            self.status_code_label.setStyleSheet("color: gray; font-weight: bold; font-size: 14px;")
