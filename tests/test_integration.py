...
class TestSendApiIntegration(unittest.TestCase):
    ...
    def test_environment_management_integration(self):
        ...
        self.main_window.environment_panel.update_environments(self.main_window.environments)
    ...
    def test_batch_testing_ui_integration(self):
        ...
        self.assertEqual(self.main_window.results_table.item(0, 0).text(), "Batch Request 1")
        self.assertEqual(self.main_window.results_table.item(1, 0).text(), "Batch Request 2")
