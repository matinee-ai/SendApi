...
class TestUIComponents(unittest.TestCase):
    ...
    def test_response_panel_creation(self):
        ...
        self.assertIsNotNone(panel.headers_table) # Changed from headers_text (now a table)
    ...
    def test_response_panel_display_response(self):
        ...
        self.assertIn("150.0", panel.response_time_label.text()) # Use response_time_label
        
        # Verify response body is displayed (formatted JSON)
        self.assertIn('"message": "success"', panel.body_edit.toPlainText()) # Changed from response_text
    ...
    def test_sidebar_update_collections(self):
        ...
        self.assertEqual(request_item.text(0), "GET Test Request")  # Expects method prefix
    ...
    def test_environment_panel_update_environments(self):
        ...
        self.assertEqual(panel.env_combo.itemText(1), "Test Environment") # "Test Environment" is at index 1
