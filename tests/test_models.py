...
from src.models import Request, Collection, Environment, Response
...
class TestRequest(unittest.TestCase):
    ...
    def test_request_creation(self):
        ...
        self.assertEqual(self.request.tests, "pm.test('Status code is 200', function () { pm.response.to.have.status(200); });")
    ...
    def test_request_to_dict(self):
        ...
        self.assertEqual(request_dict["pre_request_script"], "console.log('pre-request');")
        self.assertEqual(request_dict["tests"], "pm.test('Status code is 200', function () { pm.response.to.have.status(200); });")
...
class TestCollection(unittest.TestCase):
    ...
    def test_collection_get_all_requests(self):
        ...
        all_requests = self.collection.requests + [req for folder in self.collection.folders for req in folder.requests]
...
class TestEnvironment(unittest.TestCase):
    ...
    def test_environment_creation(self):
        ...
        self.assertEqual(self.environment.variables["API_URL"], "https://api.example.com")
    ...
    def test_environment_update_variable(self):
        ...
        self.assertEqual(self.environment.variables["API_URL"], "https://new-api.example.com")
        self.assertEqual(len(self.environment.variables), 2)
    ...
    def test_environment_to_dict(self):
        ...
        self.assertEqual(env_dict["variables"], {
...
class TestResponse(unittest.TestCase):
    ...
    def test_response_creation(self):
        ...
        self.assertEqual(self.response.headers, {"Content-Type": "application/json", "Server": "nginx"})
        self.assertEqual(self.response.body, '{"message": "success", "data": [1, 2, 3]}')
    ...
    def test_response_to_dict(self):
        ...
        self.assertEqual(response_dict["headers"], {"Content-Type": "application/json", "Server": "nginx"})
        self.assertEqual(response_dict["body"], '{"message": "success", "data": [1, 2, 3]}')
    ...
    def test_response_is_success(self):
        ...
        error_response = Response(status_code=404, headers={}, body="", response_time=0.0, size=0, url="", method="GET")
        self.assertFalse(200 <= error_response.status_code < 300)
        
        server_error_response = Response(status_code=500, headers={}, body="", response_time=0.0, size=0, url="", method="GET")
    ...
    def test_response_get_json_body(self):
        ...
        text_response = Response(status_code=200, headers={}, body="Plain text response", response_time=0.0, size=0, url="", method="GET")
        try:
